package com.ugamdemo.core.constants;
...
public final class AppConstants {
    ...
    public static final String COUNTRY_LIST_PATH = "/content/dam/ugamdemo/country1.json";
    public static final String COLOR_LIST = "colorList";
    public static final String COLOR_LIST_PATH = "/content/dam/ugamdemo/color.json";
    public static final String FONT_LIST = "fontList";
    public static final String FONT_LIST_PATH = "/content/dam/ugamdemo/font.json";
}
